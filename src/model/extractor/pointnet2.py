"""
This file contains code copied from models/pointnet2_cls_ssg.py and models/pointnet2_utils.py.

Original Code Repository: https://github.com/yanx27/Pointnet_Pointnet2_pytorch/blob/master/models/pointnet2_cls_ssg.py
